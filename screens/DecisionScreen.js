                  ...
                  <View style={styles.prefiltersInnerContainer}> 
                      <View style={styles.prefiltersScreenFormContainer}> 
                        ...
                        <View style={styles.pickerContainer}>
                          ...
                          {/* Additional cuisine options would go here */}
                          </Picker>
                        </View>
                        {/* Price Picker */}
                        ...
                        >
                        <Picker.Item label="Select max price" value="" />
                        ...
                        <View style={styles.pickerContainer}>
                            ...
                            >
                                <Picker.Item label="Select min rating" value="" />
                                <Picker.Item label="⭐ (1)" value="1" />
                                <Picker.Item label="⭐⭐ (2)" value="2" />
                                <Picker.Item label="⭐⭐⭐ (3)" value="3" />
                                <Picker.Item label="⭐⭐⭐⭐ (4)" value="4" />
                              ...
                              return (
                                ...
                                onPress={() => {
                                    ...
                                    const updatedRestaurants = filteredRestaurants.filter(
                                        (restaurant) => restaurant && restaurant.key !== chosenRestaurant?.key
                                    );
                                    ...
                                    return (
                                        <View style={styles.choiceScreenListItem}>
                                            <Text style={styles.choiceScreenListItemName}>
                                                {item.firstName} {item.lastName} ({item.relationship}) Vetoed: {item.vetoed || "no"}
                                            </Text>
